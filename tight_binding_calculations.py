...
class TightBinding(object):
    ...
    Class calculates the matrix of electron interactions between atoms (electronic band structure) in 2D structures
        ...
        4. Lattices containing diffrent types of atoms.
    ...
    def __get_non_zero_values_and_indices(self, data, calculation_type, method, distance, constants_of_pairs,
                                          atom_store, number_of_friends, lp=None, ld=None,
...
constans_of_pairs_example1 = {('C', 'C'): {'V_sssigma': 0,
                                           'V_spsigma': 0,
                                           'V_sdsigma': 0,
                                           'V_starssigma': 0,
                                           'V_starpsigma': 0,
...
eigenvaluess, eigenvectorss = tb.calculate_eigenvalues_ang_eigenvectors(dimension=dims,
